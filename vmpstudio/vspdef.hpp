...
enum vsp_event_t {
  ...
  decl_event(sample_initialized, "tell plugin a new uvm sample session initialized"),
  ...
  decl_event_result(vspinfo, ptr, "ask this plugin for its self version and description"),

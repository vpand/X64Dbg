...
class TraceBrowser : public AbstractTableView {
 ...
 public:
  ...
  QSet<int> &keypoints() { return mKeypoints; }

  void assembleToFile(const QString &title, sample_operator_t opr);
 ...
 public slots:
  void hypertraceStartSlot();
  void hypertraceStopSlot();
  void openFileSlot();
  ...
  void dyndecToFileSlot();
  void assembleToFileSlot();
  void assembleToFileCodeClearSlot();
  void restoreInstructionSlot();
  void editInstructionSlot();
  void referenceFromSlot();
  void referenceToSlot();
  void loadSamplesSlot();
  void saveSamplesSlot();
  void selectSampleSlot();
  void differSamplesSlot();
  void combineSamplesSlot();
  void staticCFGSlot();
  void executedCFGSlot();
  void combinedCFGSlot();
  void rewritedCFGSlot();
  void callGraphSlot();

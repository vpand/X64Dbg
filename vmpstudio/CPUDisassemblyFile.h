#ifndef CPUDISASSEMBLYFILE_H
#define CPUDISASSEMBLYFILE_H
...
class CPUDisassemblyFile : public DisassemblyFile {
  Q_OBJECT

 public:
  CPUDisassemblyFile(QWidget* parent, bool isMain);
  ...
  void addFollowReferenceMenuItem(QString name, dsint value, QMenu* menu,
                                  bool isReferences, bool isFollowInCPU);
  ...
  void updateFile(QThread* anathread, const QString& path) {
    mAnaThread = anathread;
    mPath = path;
    setWindowTitle(path);
  }
  ...
  bool isBusy() { return mAnaThread != nullptr; }
 ...
 private:
  ...
  // Analyze thread
  QThread* mAnaThread = nullptr;
  QString mPath;
};

#endif  // CPUDISASSEMBLYFILE_H

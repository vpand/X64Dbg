#ifndef CPUDUMPFILE_H
#define CPUDUMPFILE_H
...
class CPUDumpFile : public HexDumpFile {
  Q_OBJECT
 public:
  explicit CPUDumpFile(CPUDisassemblyFile* disas, CPUMultiDumpFile* multiDump,
                       QWidget* parent = 0);
  void getColumnRichText(int col, dsint rva,
                         RichTextPainter::List& richText) override;
 ...
 signals:
  ...
  void showDisassemblyTab(duint selectionStart, duint selectionEnd,
                          duint firstAddress);

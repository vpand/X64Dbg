...
class MainWindow : public QMainWindow {
 ...
 public:
  ...
  UrDecompiler* urdecWidget() { return mDecompView; }
 ...
 private:
  ...
  LogView* mLogView;
  UrDecompiler* mDecompView;
  VMPSymbolView* mVMPSymbolView;
  ...
  VSPluginView* mVSPManager = nullptr;
...
class VSPluginView : public StdTable {
  Q_OBJECT

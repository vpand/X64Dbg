#ifndef CPUREGISTERSVIEWA32_H
#define CPUREGISTERSVIEWA32_H

#include "RegistersViewA32.h"

class CPURegistersViewA32 : public RegistersViewA32 {
  Q_OBJECT
 public:
  CPURegistersViewA32(CPUWidget* parent = 0);

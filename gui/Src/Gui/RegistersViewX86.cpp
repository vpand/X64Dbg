...
int RegistersViewX86::getEstimateHeight() { return mRowsNeeded * mRowHeight; }

void RegistersViewX86::SetChangeButton(QPushButton* push_button) {
  mChangeViewButton = push_button;
  fontsUpdatedSlot();
}

void RegistersViewX86::InitMappings() {
  ...
  mRegisterPlaces.insert(EFLAGS,
                         Register_Position(offset++, 0, 9, sizeof(duint) * 2));
  ...
  mRegisterRelativePlaces.insert(LastError,
                                 Register_Relative_Position(IF, LastStatus));
  ...
  mRegisterRelativePlaces.insert(LastStatus,
                                 Register_Relative_Position(LastError, GS));
  ...
  if (mShowFpu) {
    ...
    if (mFpuMode == 1) {
      ...
      mRegisterRelativePlaces.insert(
          MM7, Register_Relative_Position(MM6, x87TagWord));
    }
    mRegisterRelativePlaces.insert(
        CS, Register_Relative_Position(DS, SS, ES, tempRegisterName));
    mRegisterRelativePlaces.insert(
        SS,
        Register_Relative_Position(CS, tempRegisterName, DS, tempRegisterName));

    offset++;

#if 0
    mRegisterMapping.insert(x87TagWord, "x87TagWord");
    mRegisterPlaces.insert(
        x87TagWord, Register_Position(offset++, 0, 11, sizeof(WORD) * 2));
    ...
    mRegisterRelativePlaces.insert(
        x87TagWord, Register_Relative_Position(tempRegisterName, x87TW_0));
    ...
    temp = metrics.width(QApplication::translate(
               "RegistersViewX86_ConstantsOfRegisters", "Nonzero")) /
               mCharWidth +
           13;
    NextColumnPosition = std::max(NextColumnPosition, temp);
    temp = metrics.width(QApplication::translate(
               "RegistersViewX86_ConstantsOfRegisters", "Zero")) /
               mCharWidth +
           13;
    NextColumnPosition = std::max(NextColumnPosition, temp);
    temp = metrics.width(QApplication::translate(
               "RegistersViewX86_ConstantsOfRegisters", "Special")) /
               mCharWidth +
           13;
    NextColumnPosition = std::max(NextColumnPosition, temp);
    temp = metrics.width(QApplication::translate(
               "RegistersViewX86_ConstantsOfRegisters", "Empty")) /
               mCharWidth +
           13;
    NextColumnPosition = std::max(NextColumnPosition, temp);
    ...
    mRegisterRelativePlaces.insert(
        x87TW_0,
        Register_Relative_Position(x87TagWord, x87TW_1, x87TagWord, x87TW_2));
    mRegisterMapping.insert(x87TW_1, "x87TW_1");
    mRegisterPlaces.insert(
        x87TW_1, Register_Position(offset++, NextColumnPosition, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_1,
        Register_Relative_Position(x87TW_0, x87TW_2, x87TagWord, x87TW_3));

    mRegisterMapping.insert(x87TW_2, "x87TW_2");
    mRegisterPlaces.insert(x87TW_2, Register_Position(offset, 0, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_2,
        Register_Relative_Position(x87TW_1, x87TW_3, x87TW_0, x87TW_4));
    mRegisterMapping.insert(x87TW_3, "x87TW_3");
    mRegisterPlaces.insert(
        x87TW_3, Register_Position(offset++, NextColumnPosition, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_3,
        Register_Relative_Position(x87TW_2, x87TW_4, x87TW_1, x87TW_5));

    mRegisterMapping.insert(x87TW_4, "x87TW_4");
    mRegisterPlaces.insert(x87TW_4, Register_Position(offset, 0, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_4,
        Register_Relative_Position(x87TW_3, x87TW_5, x87TW_2, x87TW_6));
    mRegisterMapping.insert(x87TW_5, "x87TW_5");
    mRegisterPlaces.insert(
        x87TW_5, Register_Position(offset++, NextColumnPosition, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_5,
        Register_Relative_Position(x87TW_4, x87TW_6, x87TW_3, x87TW_7));

    mRegisterMapping.insert(x87TW_6, "x87TW_6");
    mRegisterPlaces.insert(x87TW_6, Register_Position(offset, 0, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_6,
        Register_Relative_Position(x87TW_5, x87TW_7, x87TW_4, x87StatusWord));
    mRegisterMapping.insert(x87TW_7, "x87TW_7");
    mRegisterPlaces.insert(
        x87TW_7, Register_Position(offset++, NextColumnPosition, 8, 10));
    mRegisterRelativePlaces.insert(
        x87TW_7, Register_Relative_Position(x87TW_6, x87StatusWord, x87TW_5,
                                            x87StatusWord));
    ...
    mRegisterPlaces.insert(
        x87StatusWord, Register_Position(offset++, 0, 14, sizeof(WORD) * 2));
    mRegisterRelativePlaces.insert(
        x87StatusWord, Register_Relative_Position(x87TW_7, x87SW_B));

    mRegisterMapping.insert(x87SW_B, "x87SW_B");
    mRegisterPlaces.insert(x87SW_B, Register_Position(offset, 0, 9, 1));
    mRegisterRelativePlaces.insert(
        x87SW_B, Register_Relative_Position(x87StatusWord, x87SW_C3,
                                            x87StatusWord, x87SW_C1));
    mRegisterMapping.insert(x87SW_C3, "x87SW_C3");
    mRegisterPlaces.insert(x87SW_C3, Register_Position(offset, 12, 10, 1));
    mRegisterRelativePlaces.insert(
        x87SW_C3,
        Register_Relative_Position(x87SW_B, x87SW_C2, x87StatusWord, x87SW_C0));
    mRegisterMapping.insert(x87SW_C2, "x87SW_C2");
    mRegisterPlaces.insert(x87SW_C2, Register_Position(offset++, 25, 10, 1));
    mRegisterRelativePlaces.insert(
        x87SW_C2, Register_Relative_Position(x87SW_C3, x87SW_C1, x87StatusWord,
                                             x87SW_ES));
    ...
    mRegisterPlaces.insert(
        x87ControlWord, Register_Position(offset++, 0, 15, sizeof(WORD) * 2));
    mRegisterRelativePlaces.insert(
        x87ControlWord, Register_Relative_Position(x87SW_TOP, x87CW_IC));

    mRegisterMapping.insert(x87CW_IC, "x87CW_IC");
    mRegisterPlaces.insert(x87CW_IC, Register_Position(offset, 0, 9, 1));
    mRegisterRelativePlaces.insert(
        x87CW_IC, Register_Relative_Position(x87ControlWord, x87CW_ZM,
                                             x87ControlWord, x87CW_UM));
    mRegisterMapping.insert(x87CW_ZM, "x87CW_ZM");
    mRegisterPlaces.insert(x87CW_ZM, Register_Position(offset, 12, 10, 1));
    mRegisterRelativePlaces.insert(
        x87CW_ZM, Register_Relative_Position(x87CW_IC, x87CW_PM, x87ControlWord,
                                             x87CW_OM));
    mRegisterMapping.insert(x87CW_PM, "x87CW_PM");
    mRegisterPlaces.insert(x87CW_PM, Register_Position(offset++, 25, 10, 1));
    mRegisterRelativePlaces.insert(
        x87CW_PM, Register_Relative_Position(x87CW_ZM, x87CW_UM, x87ControlWord,
                                             x87CW_PC));
    ...
    mRegisterRelativePlaces.insert(CS,
                                   Register_Relative_Position(DS, SS, ES, DR0));
    mRegisterRelativePlaces.insert(
        SS, Register_Relative_Position(CS, DR0, DS, DR0));
  }
...
static QAction* setupAction(const QString& text,
                            RegistersViewX86* this_object) {
...
RegistersViewX86::RegistersViewX86(QWidget* parent)
    : QScrollArea(parent), mVScrollOffset(0) {
  ...
  for (REGISTER_NAME i = XMM0; i <= ArchValue(XMM7, XMM15);
       i = (REGISTER_NAME)(i + 1)) {
    mFPUXMM.insert(i);
    mMODIFYDISPLAY.insert(i);
    mUNDODISPLAY.insert(i);
  ...
  for (REGISTER_NAME i = YMM0; i <= ArchValue(YMM7, YMM15);
       i = (REGISTER_NAME)(i + 1)) {
    mFPUYMM.insert(i);
    mMODIFYDISPLAY.insert(i);
    mUNDODISPLAY.insert(i);
  ...
  // self communication for repainting (maybe some other widgets needs this
  // information, too)
  connect(this, SIGNAL(refresh()), this, SLOT(reload()));

  InitMappings();

  memset(&wRegDumpStruct, 0, sizeof(wRegDumpStruct));
  memset(&wCipRegDumpStruct, 0, sizeof(wCipRegDumpStruct));
  mCip = 0;
...
void RegistersViewX86::refreshShortcutsSlot() {}

/**
 * @brief RegistersViewX86::~RegistersViewX86 The destructor.
 */
RegistersViewX86::~RegistersViewX86() {}

void RegistersViewX86::fontsUpdatedSlot() {
  if (!isEnabled()) return;

  auto font = ConfigFont("Registers");
  setFont(font);
  if (mChangeViewButton) mChangeViewButton->setFont(font);
...
void RegistersViewX86::displayCustomContextMenuSlot(QPoint pos) {}

void RegistersViewX86::ShowFPU(bool set_showfpu) {
 ...
 */
bool RegistersViewX86::identifyRegister(const int line, const int offset,
                                        REGISTER_NAME* clickedReg) {
  // we start by an unknown register id
  if (clickedReg) *clickedReg = UNKNOWN;
  bool found_flag = false;
  QMap<REGISTER_NAME, Register_Position>::const_iterator it =
      mRegisterPlaces.begin();
  ...
  while (it != mRegisterPlaces.end()) {
    if ((it.value().line == (line - mVScrollOffset)) /* same line ? */
        ...
        && (offset <= (1 + it.value().start + it.value().labelwidth +
                       it.value().valuesize)) /* ... and end ? */
    ) {
      // we found a matching register in the viewport
      if (clickedReg) *clickedReg = (REGISTER_NAME)it.key();
      found_flag = true;
      break;
    }
    ++it;
...
/**
 * @brief RegistersViewX86::helpRegister Get the help information of a register.
 * The help information is from Intel's manual.
 * @param reg The register name
 * @return The help information, possibly translated to the native language, or
 * empty if the help information is not available yet.
 */
QString RegistersViewX86::helpRegister(REGISTER_NAME reg) {
  switch (reg) {
    // We don't display help messages for general purpose registers as they are
    // very well-known.
    case CF:
      return tr(
          "CF (bit 0) : Carry flag - Set if an arithmetic operation generates "
          "a carry or a borrow out of the mostsignificant bit of the result; "
          "cleared otherwise.\n"
    ...
    case PF:
      return tr(
          "PF (bit 2) : Parity flag - Set if the least-significant byte of the "
          "result contains an even number of 1 bits; cleared otherwise.");
    case AF:
      return tr(
          "AF (bit 4) : Auxiliary Carry flag - Set if an arithmetic operation "
          "generates a carry or a borrow out of bit\n"
          "3 of the result; cleared otherwise. This flag is used in "
          "binary-coded decimal (BCD) arithmetic.");
    case ZF:
      return tr(
          "ZF (bit 6) : Zero flag - Set if the result is zero; cleared "
          "otherwise.");
    case SF:
      return tr(
          "SF (bit 7) : Sign flag - Set equal to the most-significant bit of "
          "the result, which is the sign bit of a signed\n"
          "integer. (0 indicates a positive value and 1 indicates a negative "
          "value.)");
    case OF:
      return tr(
          "VF (bit 11) : Overflow flag - Set if the integer result is too "
          "large a positive number or too small a negative\n"
          "number (excluding the sign-bit) to fit in the destination operand; "
          "cleared otherwise. This flag indicates an overflow\n"
          "condition for signed-integer (two’s complement) arithmetic.");
    case DF:
      return tr(
          "DF (bit 10) : The direction flag controls string instructions "
          "(MOVS, CMPS, SCAS, LODS, and STOS). Setting the DF flag causes the "
          "string instructions\n"
          "to auto-decrement (to process strings from high addresses to low "
          "addresses). Clearing the DF flag causes the string instructions to "
          "auto-increment\n"
          "(process strings from low addresses to high addresses).");
    case TF:
      return tr(
          "TF (bit 8) : Trap flag - Set to enable single-step mode for "
          "debugging; clear to disable single-step mode.");
    case IF:
      return tr(
    ...
    case x87ControlWord:
      return tr(
          "The 16-bit x87 FPU control word controls the precision of the x87 "
          "FPU and rounding method used. It also contains the x87 FPU "
          "floating-point exception mask bits.");
    case x87StatusWord:
      return tr(
          "The 16-bit x87 FPU status register indicates the current state of "
          "the x87 FPU.");
    case x87TagWord:
      return tr(
          "The 16-bit tag word indicates the contents of each the 8 registers "
          "in the x87 FPU data-register stack (one 2-bit tag per register).");

    case x87CW_PC:
      return tr(
          "The precision-control (PC) field (bits 8 and 9 of the x87 FPU "
          "control word) determines the precision (64, 53, or 24 bits) of "
          "floating-point calculations made by the x87 FPU");
    case x87CW_RC:
      return tr(
          "The rounding-control (RC) field of the x87 FPU control register "
          "(bits 10 and 11) controls how the results of x87 FPU floating-point "
          "instructions are rounded.");
    case x87CW_IC:
      return tr(
          "The infinity control flag (bit 12 of the x87 FPU control word) is "
          "provided for compatibility with the Intel 287 Math Coprocessor;\n"
          "it is not meaningful for later version x87 FPU coprocessors or "
          "IA-32 processors.");
    case x87CW_IM:
      return tr(
          "The invalid operation exception mask (bit 0). When the mask bit is "
          "set, its corresponding exception is blocked from being generated.");
    case x87CW_DM:
      return tr(
          "The denormal-operand exception mask (bit 2). When the mask bit is "
          "set, its corresponding exception is blocked from being generated.");
    case x87CW_ZM:
      return tr(
          "The floating-point divide-by-zero exception mask (bit 3). When the "
          "mask bit is set, its corresponding exception is blocked from being "
          "generated.");
    case x87CW_OM:
      return tr(
          "The floating-point numeric overflow exception mask (bit 4). When "
          "the mask bit is set, its corresponding exception is blocked from "
          "being generated.");
    case x87CW_UM:
      return tr(
          "The potential floating-point numeric underflow condition mask (bit "
          "5). When the mask bit is set, its corresponding exception is "
          "blocked from being generated.");
    case x87CW_PM:
      return tr(
          "The inexact-result/precision exception mask (bit 6). When the mask "
          "bit is set, its corresponding exception is blocked from being "
          "generated.");

    case x87SW_B:
      return tr(
          "The busy flag (bit 15) indicates if the FPU is busy (B=1) while "
          "executing an instruction, or is idle (B=0).\n"
          "The B-bit (bit 15) is included for 8087 compatibility only. It "
          "reflects the contents of the ES flag.");
    case x87SW_C0:
      return tr("The C%1 condition code flag (bit %2) is used to indicate the "
                "results of floating-point comparison and arithmetic "
                "operations.")
          .arg(0)
          .arg(8);
    case x87SW_C1:
    ...
    case x87SW_ES:
      return tr(
          "The error/exception summary status flag (bit 7) is set when any of "
          "the unmasked exception flags are set.");
    case x87SW_SF:
      return tr(
          "The stack fault flag (bit 6 of the x87 FPU status word) indicates "
          "that stack overflow or stack underflow has occurred with data\nin "
          "the x87 FPU data register stack.");
    case x87SW_TOP:
      return tr(
          "A pointer to the x87 FPU data register that is currently at the top "
          "of the x87 FPU register stack is contained in bits 11 through 13\n"
          "of the x87 FPU status word. This pointer, which is commonly "
          "referred to as TOP (for top-of-stack), is a binary value from 0 to "
          "7.");
    case x87SW_I:
      return tr(
          "The processor reports an invalid operation exception (bit 0) in "
          "response to one or more invalid arithmetic operands.");
    case x87SW_D:
      return tr(
          "The processor reports the denormal-operand exception (bit 2) if an "
          "arithmetic instruction attempts to operate on a denormal operand.");
    case x87SW_Z:
      return tr(
          "The processor reports the floating-point divide-by-zero exception "
          "(bit 3) whenever an instruction attempts to divide a finite "
          "non-zero operand by 0.");
    case x87SW_O:
      return tr(
          "The processor reports a floating-point numeric overflow exception "
          "(bit 4) whenever the rounded result of an instruction exceeds the "
          "largest allowable finite value that will fit into the destination "
          "operand.");
    case x87SW_U:
      return tr(
          "The processor detects a potential floating-point numeric underflow "
          "condition (bit 5) whenever the result of rounding with unbounded "
          "exponent is non-zero and tiny.");
    case x87SW_P:
      return tr(
          "The inexact-result/precision exception (bit 6) occurs if the result "
          "of an operation is not exactly representable in the destination "
          "format.");

    case MxCsr:
      return tr(
          "The 32-bit MXCSR register contains control and status information "
          "for SIMD floating-point operations.");
    case MxCsr_IE:
      return tr(
          "Bit 0 (IE) : Invalid Operation Flag; indicate whether a SIMD "
          "floating-point exception has been detected.");
    case MxCsr_DE:
      return tr(
          "Bit 1 (DE) : Denormal Flag; indicate whether a SIMD floating-point "
          "exception has been detected.");
    case MxCsr_ZE:
      return tr(
          "Bit 2 (ZE) : Divide-by-Zero Flag; indicate whether a SIMD "
          "floating-point exception has been detected.");
    case MxCsr_OE:
      return tr(
          "Bit 3 (OE) : Overflow Flag; indicate whether a SIMD floating-point "
          "exception has been detected.");
    case MxCsr_UE:
      return tr(
          "Bit 4 (UE) : Underflow Flag; indicate whether a SIMD floating-point "
          "exception has been detected.");
    case MxCsr_PE:
      return tr(
          "Bit 5 (PE) : Precision Flag; indicate whether a SIMD floating-point "
          "exception has been detected.");
    case MxCsr_IM:
      return tr(
          "Bit 7 (IM) : Invalid Operation Mask. When the mask bit is set, its "
          "corresponding exception is blocked from being generated.");
    case MxCsr_DM:
      return tr(
          "Bit 8 (DM) : Denormal Mask. When the mask bit is set, its "
          "corresponding exception is blocked from being generated.");
    case MxCsr_ZM:
      return tr(
          "Bit 9 (ZM) : Divide-by-Zero Mask. When the mask bit is set, its "
          "corresponding exception is blocked from being generated.");
    case MxCsr_OM:
      return tr(
          "Bit 10 (OM) : Overflow Mask. When the mask bit is set, its "
          "corresponding exception is blocked from being generated.");
    case MxCsr_UM:
      return tr(
          "Bit 11 (UM) : Underflow Mask. When the mask bit is set, its "
          "corresponding exception is blocked from being generated.");
    case MxCsr_PM:
      return tr(
          "Bit 12 (PM) : Precision Mask. When the mask bit is set, its "
          "corresponding exception is blocked from being generated.");
    case MxCsr_FZ:
      return tr(
          "Bit 15 (FZ) of the MXCSR register enables the flush-to-zero mode, "
          "which controls the masked response to a SIMD floating-point "
          "underflow condition.");
    case MxCsr_DAZ:
      return tr(
          "Bit 6 (DAZ) of the MXCSR register enables the denormals-are-zeros "
          "mode, which controls the processor’s response to a SIMD "
          "floating-point\n"
          "denormal operand condition.");
    case MxCsr_RC:
      return tr(
          "Bits 13 and 14 of the MXCSR register (the rounding control [RC] "
          "field) control how the results of SIMD floating-point instructions "
          "are rounded.");
    case LastError: {
      char dat[1024];
      LASTERROR* error;
    ...
    case GS:
      return tr(
          "The TEB of the current thread can be accessed as an offset of "
          "segment register GS (x64).\nThe TEB can be used to get a lot of "
          "information on the process without calling Win32 API.");
#else   // x86
    case FS:
      return tr(
          "The TEB of the current thread can be accessed as an offset of "
          "segment register FS (x86).\nThe TEB can be used to get a lot of "
          "information on the process without calling Win32 API.");
#endif  //_WIN64
    default:
      return QString();
...
void RegistersViewX86::mousePressEvent(QMouseEvent* event) {
  if (!isActive) return;
...
void RegistersViewX86::mouseMoveEvent(QMouseEvent* event) {
  if (!isActive) {
  ...
  REGISTER_NAME r = UNKNOWN;
  QString registerHelpInformation;
  // do we find a corresponding register?
  if (identifyRegister((event->y() - yTopSpacing) / (double)mRowHeight,
                       event->x() / (double)mCharWidth, &r)) {
...
void RegistersViewX86::mouseDoubleClickEvent(QMouseEvent* event) {}

void RegistersViewX86::paintEvent(QPaintEvent* event) {
  Q_UNUSED(event);
  ...
  wPainter.fillRect(wPainter.viewport(),
                    QBrush(ConfigColor("RegistersBackgroundColor")));

  // Don't draw the registers if a program isn't actually running
  if (!isActive) return;

  // Iterate all registers
  for (auto itr = mRegisterMapping.begin(); itr != mRegisterMapping.end();
       itr++) {
    // Paint register at given position
    drawRegister(&wPainter, itr.key(),
                 registerValue(&wRegDumpStruct, itr.key()));
  }
}

void RegistersViewX86::keyPressEvent(QKeyEvent* event) {
  QScrollArea::keyPressEvent(event);
}

QSize RegistersViewX86::sizeHint() const {
  // 32 character width
  return QSize(32 * mCharWidth, this->viewport()->height());
}

void* RegistersViewX86::operator new(size_t size) {
  return _aligned_malloc(size, 16);
}

void RegistersViewX86::operator delete(void* p) { _aligned_free(p); }
 ...
 * @return                  the label
 */
QString RegistersViewX86::getRegisterLabel(REGISTER_NAME register_selected) {
  ...
  QString valueText =
      QString("%1")
          .arg((*((duint*)registerValue(&wRegDumpStruct, register_selected))),
               mRegisterPlaces[register_selected].valuesize, 16, QChar('0'))
          .toUpper();
  duint register_value =
      (*((duint*)registerValue(&wRegDumpStruct, register_selected)));
...
/**
 * @brief RegistersViewX86::GetRegStringValueFromValue Get the textual
 * representation of the register value.
 ...
 *
 * This value does not return hex representation all the times for SIMD
 * registers. The actual representation of SIMD registers depends on the user
 * settings.
 */
QString RegistersViewX86::GetRegStringValueFromValue(REGISTER_NAME reg,
                                                     const char* value) {
  QString valueText;

  if (mUINTDISPLAY.contains(reg))
    valueText = QString("%1")
                    .arg((*((const duint*)value)),
                         mRegisterPlaces[reg].valuesize, 16, QChar('0'))
                    .toUpper();
  else if (mUSHORTDISPLAY.contains(reg))
    valueText = QString("%1")
                    .arg((*((const unsigned short*)value)),
                         mRegisterPlaces[reg].valuesize, 16, QChar('0'))
                    .toUpper();
  else if (mDWORDDISPLAY.contains(reg))
    valueText = QString("%1")
                    .arg((*((const DWORD*)value)),
                         mRegisterPlaces[reg].valuesize, 16, QChar('0'))
                    .toUpper();
  else if (mBOOLDISPLAY.contains(reg))
    valueText = QString("%1")
                    .arg((*((const bool*)value)),
                         mRegisterPlaces[reg].valuesize, 16, QChar('0'))
                    .toUpper();
  else if (mFIELDVALUE.contains(reg)) {
    if (mTAGWORD.contains(reg)) {
      valueText = QString("%1")
                      .arg((*((const unsigned short*)value)), 1, 16, QChar('0'))
                      .toUpper();
      valueText += QString(" (");
    ...
    if (reg == MxCsr_RC) {
      ...
      valueText += QString(" (");
      valueText +=
          GetControlWordRCStateString((*((const unsigned short*)value)));
      valueText += QString(")");
      ...
      valueText += QString(" (");
      valueText +=
          GetControlWordPCStateString((*((const unsigned short*)value)));
      valueText += QString(")");
      ...
      valueText +=
          GetStatusWordTOPStateString((*((const unsigned short*)value)));
      valueText += QString(")");
    }
    ...
    bool bFpuRegistersLittleEndian =
        ConfigBool("Gui", "FpuRegistersLittleEndian");
    if (size != 0) {
...
static STRING_VALUE_TABLE_t MxCsrRCValueStringTable[] = {
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Toward Zero"),
     MxCsr_RC_TOZERO},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters",
                       "Toward Positive"),
     MxCsr_RC_POSITIVE},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters",
                       "Toward Negative"),
     MxCsr_RC_NEGATIVE},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Round Near"),
     MxCsr_RC_NEAR}};
// WARNING: The following function is commented out because it is not used
// currently. If it is used again, it should be modified to keep working under
// internationized environment.
/*
unsigned int RegistersViewX86::GetMxCsrRCValueFromString(const char* string)
{
    int i;

    for(i = 0; i < (sizeof(MxCsrRCValueStringTable) /
sizeof(*MxCsrRCValueStringTable)); i++)
    {
...
*/
QString RegistersViewX86::GetMxCsrRCStateString(unsigned short state) {
  int i;

  for (i = 0;
       i < (sizeof(MxCsrRCValueStringTable) / sizeof(*MxCsrRCValueStringTable));
       i++) {
    if (MxCsrRCValueStringTable[i].value == state)
      return QApplication::translate("RegistersViewX86_ConstantsOfRegisters",
                                     MxCsrRCValueStringTable[i].string);
  }
...
static STRING_VALUE_TABLE_t ControlWordRCValueStringTable[] = {
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Truncate"),
     x87CW_RC_TRUNCATE},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Round Up"),
     x87CW_RC_UP},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Round Down"),
     x87CW_RC_DOWN},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Round Near"),
     x87CW_RC_NEAR}};
// WARNING: The following function is commented out because it is not used
...
// internationized environment.
/*
unsigned int RegistersViewX86::GetControlWordRCValueFromString(const char*
string)
{
    int i;

    for(i = 0; i < (sizeof(ControlWordRCValueStringTable) /
sizeof(*ControlWordRCValueStringTable)); i++)
    {
...
*/
QString RegistersViewX86::GetControlWordRCStateString(unsigned short state) {
  int i;

  for (i = 0; i < (sizeof(ControlWordRCValueStringTable) /
                   sizeof(*ControlWordRCValueStringTable));
       i++) {
    if (ControlWordRCValueStringTable[i].value == state)
      return QApplication::translate("RegistersViewX86_ConstantsOfRegisters",
                                     ControlWordRCValueStringTable[i].string);
  }
...
static STRING_VALUE_TABLE_t StatusWordTOPValueStringTable[] = {
    {"x87r0", x87SW_TOP_0}, {"x87r1", x87SW_TOP_1}, {"x87r2", x87SW_TOP_2},
    {"x87r3", x87SW_TOP_3}, {"x87r4", x87SW_TOP_4}, {"x87r5", x87SW_TOP_5},
    {"x87r6", x87SW_TOP_6}, {"x87r7", x87SW_TOP_7}};
// WARNING: The following function is commented out because it is not used
// currently. If it is used again, it should be modified to keep working under
// internationized environment.
/*
unsigned int RegistersViewX86::GetStatusWordTOPValueFromString(const char*
string)
{
    int i;

    for(i = 0; i < (sizeof(StatusWordTOPValueStringTable) /
sizeof(*StatusWordTOPValueStringTable)); i++)
    {
...
*/
QString RegistersViewX86::GetStatusWordTOPStateString(unsigned short state) {
  int i;

  for (i = 0; i < (sizeof(StatusWordTOPValueStringTable) /
                   sizeof(*StatusWordTOPValueStringTable));
       i++) {
...
static STRING_VALUE_TABLE_t ControlWordPCValueStringTable[] = {
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Real4"),
     x87CW_PC_REAL4},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Not Used"),
     x87CW_PC_NOTUSED},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Real8"),
     x87CW_PC_REAL8},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Real10"),
     x87CW_PC_REAL10}};
/*
//WARNING: The following function is commented out because it is not used
currently. If it is used again, it should be modified to keep working under
internationized environment. unsigned int
RegistersViewX86::GetControlWordPCValueFromString(const char* string)
{
    int i;

    for(i = 0; i < (sizeof(ControlWordPCValueStringTable) /
sizeof(*ControlWordPCValueStringTable)); i++)
    {
...
QString RegistersViewX86::GetControlWordPCStateString(unsigned short state) {
  int i;
  ...
  for (i = 0; i < (sizeof(ControlWordPCValueStringTable) /
    ...
    if (ControlWordPCValueStringTable[i].value == state)
      return QApplication::translate("RegistersViewX86_ConstantsOfRegisters",
                                     ControlWordPCValueStringTable[i].string);
  }
...
static STRING_VALUE_TABLE_t TagWordValueStringTable[] = {
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Nonzero"),
     X87FPU_TAGWORD_NONZERO},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Zero"),
     X87FPU_TAGWORD_ZERO},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Special"),
     X87FPU_TAGWORD_SPECIAL},
    {QT_TRANSLATE_NOOP("RegistersViewX86_ConstantsOfRegisters", "Empty"),
     X87FPU_TAGWORD_EMPTY}};
// WARNING: The following function is commented out because it is not used
// currently. If it is used again, it should be modified to keep working under
// internationized environment.
/*
unsigned int RegistersViewX86::GetTagWordValueFromString(const char* string)
{
    int i;

    for(i = 0; i < (sizeof(TagWordValueStringTable) /
sizeof(*TagWordValueStringTable)); i++)
    {
...
*/
QString RegistersViewX86::GetTagWordStateString(unsigned short state) {
  int i;

  for (i = 0;
       i < (sizeof(TagWordValueStringTable) / sizeof(*TagWordValueStringTable));
       i++) {
    if (TagWordValueStringTable[i].value == state)
      return QApplication::translate("RegistersViewX86_ConstantsOfRegisters",
                                     TagWordValueStringTable[i].string);
  }

  return tr("Unknown");
}

void RegistersViewX86::drawRegister(QPainter* p, REGISTER_NAME reg,
                                    char* value) {
  ...
  if (mRegisterMapping.contains(reg)) {
    ...
    */
    ...
    for (const auto& reg : mHighlightRegs) {
      if (!ZydisTokenizer::tokenTextPoolEquals(regName, reg.first)) continue;
    ...
    if (highlight) {
      ...
      if (highlightColor.alpha()) {
        ...
        p->drawLine(x + 1, y + mRowHeight - 1,
                    x + mCharWidth * regName.length() - 1, y + mRowHeight - 1);
      }
    }
    ...
    if (mSelected == reg) {
      p->fillRect(x, y, width, mRowHeight,
                  QBrush(ConfigColor("RegistersSelectionColor")));
      // p->fillRect(QRect(x + (mRegisterPlaces[reg].labelwidth)*mCharWidth
      // ,mRowHeight*(mRegisterPlaces[reg].line)+2,
      // mRegisterPlaces[reg].valuesize*mCharWidth, mRowHeight),
      // QBrush(ConfigColor("RegistersSelectionColor")));
    }

    // draw value
    p->drawText(x, y, width, mRowHeight, Qt::AlignVCenter, valueText);
    // p->drawText(x + (mRegisterPlaces[reg].labelwidth)*mCharWidth
    // ,mRowHeight*(mRegisterPlaces[reg].line+1),QString("%1").arg(value,
    // mRegisterPlaces[reg].valuesize, 16, QChar('0')).toUpper());
    ...
    if (mFPUx87_80BITSDISPLAY.contains(reg) && isActive) {
      ...
      if (reg >= x87r0 && reg <= x87r7) {
        newText = QString("ST%1 ").arg(
            ((X87FPUREGISTER*)registerValue(&wRegDumpStruct, reg))->st_value);
      } else {
        newText = QString("x87r%1 ").arg(
            (wRegDumpStruct.x87StatusWordFields.TOP + (reg - x87st0)) & 7);
      }
      ...
      if (reg >= x87r0 && reg <= x87r7 &&
          mRegisterUpdates.contains((REGISTER_NAME)(x87TW_0 + (reg - x87r0))))
        p->setPen(ConfigColor("RegistersModifiedColor"));

      newText +=
          GetTagWordStateString(
              ((X87FPUREGISTER*)registerValue(&wRegDumpStruct, reg))->tag) +
          QString(" ");
      ...
      newText += ToLongDoubleString(
          ((X87FPUREGISTER*)registerValue(&wRegDumpStruct, reg))->data);
      width = fontMetrics.width(newText);
      p->drawText(x, y, width, mRowHeight, Qt::AlignVCenter, newText);
    }
...
void RegistersViewX86::appendRegister(QString& text, REGISTER_NAME reg,
                                      const char* name64, const char* name32) {
  QString symbol;
#ifdef _WIN64
  Q_UNUSED(name32);
  text.append(name64);
...
#endif  //_WIN64
  text.append(
      GetRegStringValueFromValue(reg, registerValue(&wRegDumpStruct, reg)));
...
void RegistersViewX86::onChangeFPUViewAction() { ShowFPU(!mShowFpu); }

void RegistersViewX86::onCopyAllAction() {
  QString text;
  ...
  appendRegister(text, REGISTER_NAME::LastError,
                 "LastError : ", "LastError : ");
  appendRegister(text, REGISTER_NAME::LastStatus,
  ...
  if (mShowFpu) {
    ...
    appendRegister(text, REGISTER_NAME::x87TagWord,
                   "x87TagWord : ", "x87TagWord : ");
    appendRegister(text, REGISTER_NAME::x87ControlWord,
                   "x87ControlWord : ", "x87ControlWord : ");
    appendRegister(text, REGISTER_NAME::x87StatusWord,
                   "x87StatusWord : ", "x87StatusWord : ");
    ...
    appendRegister(text, REGISTER_NAME::x87SW_TOP,
                   "x87SW_TOP : ", "x87SW_TOP : ");
    ...
    appendRegister(text, REGISTER_NAME::MxCsr_DAZ,
                   "MxCsr_DAZ : ", "MxCsr_DAZ : ");
...
void RegistersViewX86::debugStateChangedSlot(DBGSTATE state) {}

void RegistersViewX86::reload() { this->viewport()->update(); }

SIZE_T RegistersViewX86::GetSizeRegister(const REGISTER_NAME reg_name) {
  SIZE_T size;
...
int RegistersViewX86::CompareRegisters(const REGISTER_NAME reg_name,
                                       REGDUMP* regdump1, REGDUMP* regdump2) {
  ...
  if (size != 0) return memcmp(reg1_data, reg2_data, size);

  return -1;
}

char* RegistersViewX86::registerValue(const REGDUMP* regdraw,
                                      const REGISTER_NAME reg) {
  static int null_value = 0;
  const REGDUMPX64* regd = (REGDUMPX64*)regdraw;
  // this is probably the most efficient general method to access the values of
  // the struct
  // TODO: add an array with something like: return array[reg].data, this is
  // more fast :-)
  switch (reg) {
    case CAX:
    ...
    case x87st1:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 1) & 7];
    case x87st2:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 2) & 7];
    case x87st3:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 3) & 7];
    case x87st4:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 4) & 7];
    case x87st5:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 5) & 7];
    case x87st6:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 6) & 7];
    case x87st7:
      return (char*)&regd
          ->x87FPURegisters[(regd->x87StatusWordFields.TOP + 7) & 7];
...
void RegistersViewX86::setRegisters(REGDUMP* regraw) {
  REGDUMPX64* reg = (REGDUMPX64*)regraw;
  ...
  if (mCip != reg->regcontext.cip) wCipRegDumpStruct = wRegDumpStruct;

  // force repaint
  emit refresh();
}

void RegistersViewX86::ensureRegisterVisible(REGISTER_NAME reg) {
  QScrollArea* upperScrollArea =
      (QScrollArea*)this->parentWidget()->parentWidget();

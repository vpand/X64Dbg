#ifndef CPUREGISTERSVIEWX64_H
#define CPUREGISTERSVIEWX64_H

#include "RegistersViewX64.h"

class CPURegistersViewX64 : public RegistersViewX64 {
  Q_OBJECT
 public:
  CPURegistersViewX64(CPUWidget* parent = 0);

#ifndef CPUREGISTERSVIEWX86_H
#define CPUREGISTERSVIEWX86_H

#include "RegistersViewX86.h"

class CPURegistersViewX86 : public RegistersViewX86 {
  Q_OBJECT
 public:
  CPURegistersViewX86(CPUWidget* parent = 0);
 ...
 protected slots:
  ...
  void onSIMDMode();
  void onFpuMode();
  void ModifyFields(const QString& title, STRING_VALUE_TABLE_t* table,
                    SIZE_T size);

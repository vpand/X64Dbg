#ifndef REGISTERSVIEWA32_H
#define REGISTERSVIEWA32_H
...
class RegistersViewA32 : public QScrollArea {
  Q_OBJECT
 ...
 public:
  ...
  struct Register_Relative_Position {
    ...
    Register_Relative_Position(REGISTER_NAME l, REGISTER_NAME r,
                               REGISTER_NAME u, REGISTER_NAME d) {
      left = l;
      right = r;
      up = u;
      down = d;
  ...
  explicit RegistersViewA32(QWidget* parent);
  ~RegistersViewA32();
 ...
 protected slots:
  ...
  int CompareRegisters(const REGISTER_NAME reg_name, REGDUMP* regdump1,
                       REGDUMP* regdump2);
  ...
  void appendRegister(QString& text, REGISTER_NAME reg, const char* name64,
                      const char* name32);
 ...
 protected:
  ...
  REGDUMPA32 wRegDumpStruct;
  REGDUMPA32 wCipRegDumpStruct;

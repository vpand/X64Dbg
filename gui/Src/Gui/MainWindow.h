...
class MainWindow : public QMainWindow {
 ...
 public slots:
  ...
  void openFileSlot();
  void launchiOSAppSlot();
  void launchApkAppSlot();
  void openPythonFileSlot();
  void openADCppFileSlot();
  void openADCppModuleSlot();
  void openCompileADCppSlot();
...
class ADPluginView : public StdTable {
  Q_OBJECT

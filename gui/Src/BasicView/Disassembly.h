...
class Disassembly : public AbstractTableView {
 ...
 public:
  ...
  Instruction_t DisassembleAt(dsint rva, const char *opbuff);
  ...
  const ManaFunc* rvaToFunction(duint rva, bool eq) const {
 ...
 protected:
  ...
  OpcodePage* mMemPage;
  ManaDatabase* mManaDB = nullptr;  // YYDCore analyzed binary data

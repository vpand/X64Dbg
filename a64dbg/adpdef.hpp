...
enum adp_platform_t {
  ...
  adp_local_uraniumvm,           // Local UraniumVM
  adp_remote_uraniumvm_ios,      // Remote UraniumVM iOS
  adp_remote_uraniumvm_android,  // Remote UraniumVM Android
  adp_invalid_platform,
};

// Deprecated old platform name
#define adp_local_unicornvm adp_local_uraniumvm
#define adp_remote_unicornvm_ios adp_remote_uraniumvm_ios
#define adp_remote_unicornvm_android adp_remote_uraniumvm_android
